...
**Note:** Blitz.js is currently solely focused on supporting our needs [@nexus-stats](https://github.com/nexus-devs/nexus-stats). However, we believe that guiding the design of this framework with a real project, solving real problems will ultimately result in a better outcome than trying to generically fit everyone. 
