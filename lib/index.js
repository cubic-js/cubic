...
var $export = function (type, name, source) {
  ...
  for (key in source) {
    ...
    : IS_BIND && own ? require$$0$3(out, global$1)
    : IS_WRAP && target[key] == out ? (function (C) {
      ...
      return F;
    })(out) : IS_PROTO && typeof out == 'function' ? require$$0$3(Function.call, out) : out;
    if (IS_PROTO) {
...
var _setSpecies = function (KEY) {
  var C = typeof require$$1$1[KEY] == 'function' ? require$$1$1[KEY] : global$1[KEY];
  if (require$$0$2 && C && !C[SPECIES$1]) dP$1.f(C, SPECIES$1, {
    configurable: true,
...
$export$1($export$1.P + $export$1.R, 'Promise', { 'finally': function (onFinally) {
  var C = speciesConstructor(this, require$$1$1.Promise || global$1.Promise);
...
var require$$0$12 = ( promise$1 && promise ) || promise$1;
...
var require$$0$14 = ( assign$1 && assign ) || assign$1;
...
var require$$0$15 = ( defineProperty$1 && defineProperty ) || defineProperty$1;
...
var require$$0$16 = ( _objectSap$1 && _objectSap ) || _objectSap$1;

require$$0$16('getPrototypeOf', function () {
...
var require$$0$18 = ( iterator$1 && iterator ) || iterator$1;
...
var require$$0$19 = ( _objectGopn$1 && _objectGopn ) || _objectGopn$1;

var gOPN = require$$0$19.f;
...
var f$7 = require$$0$2 ? gOPD : function getOwnPropertyDescriptor(O, P) {
  O = toIObject(O);
  P = toPrimitive(P, true);
  if (IE8_DOM_DEFINE) try {
    return gOPD(O, P);
...
var require$$0$20 = ( _meta$1 && _meta ) || _meta$1;

var require$$0$21 = ( _wksDefine$1 && _wksDefine ) || _wksDefine$1;
...
if (!USE_NATIVE$1) {
  $Symbol = function Symbol() {
    ...
    if (require$$0$2 && setter) setSymbolDesc(ObjectProto$1, tag, { configurable: true, set: $set });
    return wrap(tag);
  };
  ...
  require$$0$19.f = gOPNExt.f = $getOwnPropertyNames;
  pIE.f = $propertyIsEnumerable;
  gOPS.f = $getOwnPropertySymbols;
  if (require$$0$2 && !LIBRARY) {
...
for (var wellKnownSymbols = getKeys(require$$0$8.store), k = 0; wellKnownSymbols.length > k;) require$$0$21(wellKnownSymbols[k++]);
...
require$$0$21('asyncIterator');

require$$0$21('observable');
...
var require$$0$22 = ( symbol$1 && symbol ) || symbol$1;
...
var require$$0$23 = ( _setProto$1 && _setProto ) || _setProto$1;

$export$1($export$1.S, 'Object', { setPrototypeOf: require$$0$23.set });
...
var require$$0$24 = ( setPrototypeOf$1 && setPrototypeOf ) || setPrototypeOf$1;
...
var require$$0$25 = ( create$2 && create$1 ) || create$2;
            ...
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                return _context3.abrupt('return', new _Promise(function (resolve, reject) {
                  ...
                  _this.client.once('error', reject);
                }));
              case 7:
              case 'end':
                return _context3.stop();
