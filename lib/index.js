...
var $export = function (type, name, source) {
  ...
  for (key in source) {
    ...
    : IS_BIND && own ? require$$0$4(out, require$$0$2)
    : IS_WRAP && target[key] == out ? (function (C) {
      ...
      return F;
    })(out) : IS_PROTO && typeof out == 'function' ? require$$0$4(Function.call, out) : out;
    if (IS_PROTO) {
      (exports.virtual || (exports.virtual = {}))[key] = out;
      if (type & $export.R && expProto && !expProto[key]) require$$0$5(expProto, key, out);
    }
  }
};
$export.F = 1;
...
var require$$0$6 = ( _shared$1 && _shared ) || _shared$1;

var uid = ( _uid$1 && _uid ) || _uid$1;

var shared = require$$0$6('keys');
...
var require$$0$8 = ( _enumBugKeys$1 && _enumBugKeys ) || _enumBugKeys$1;

var _objectKeys = Object.keys || function keys(O) {
  return $keys(O, require$$0$8);
};
...
var createDict = function () {
  ...
  while (i--) delete createDict[PROTOTYPE$1][require$$0$8[i]];
  return createDict();
};
...
var require$$0$9 = ( _wks$1 && _wks ) || _wks$1;

var def = dP$1.f;
var TAG = require$$0$9('toStringTag');
...
var IteratorPrototype = {};
require$$0$5(IteratorPrototype, require$$0$9('iterator'), function () { return this; });
...
var ITERATOR = require$$0$9('iterator');
...
var _iterDefine = function (Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCED) {
  ...
  if ($anyNative) {
    ...
    if (IteratorPrototype !== Object.prototype && IteratorPrototype.next) {
      ...
      if (!LIBRARY && !has(IteratorPrototype, ITERATOR)) require$$0$5(IteratorPrototype, ITERATOR, returnThis);
    }
  }
...
var require$$0$b = ( _iterDefine$1 && _iterDefine ) || _iterDefine$1;

var $at = require$$0$a(true);
require$$0$b(String, 'String', function (iterated) {
...
var es6_array_iterator = require$$0$b(Array, 'Array', function (iterated, kind) {
...
var TO_STRING_TAG = require$$0$9('toStringTag');
...
for (var i = 0; i < DOMIterables.length; i++) {
  ...
  if (proto && !proto[TO_STRING_TAG]) require$$0$5(proto, TO_STRING_TAG, NAME);
  Iterators[NAME] = Iterators.Array;
}

var TAG$1 = require$$0$9('toStringTag');
...
var ITERATOR$1 = require$$0$9('iterator');
...
var ITERATOR$2 = require$$0$9('iterator');
...
var SPECIES = require$$0$9('species');
...
var require$$0$c = ( _task$1 && _task ) || _task$1;

var macrotask = require$$0$c.set;
...
var _redefineAll = function (target, src, safe) {
  for (var key in src) {
    ...
    else require$$0$5(target, key, src[key]);
  } return target;
};
...
var SPECIES$1 = require$$0$9('species');
...
var ITERATOR$3 = require$$0$9('iterator');
...
var USE_NATIVE = !!function () {
  try {
    ...
    var FakePromise = (promise.constructor = {})[require$$0$9('species')] = function (exec) {
      exec(empty, empty);
    };
...
var require$$0$d = ( promise$1 && promise ) || promise$1;

var promise$2 = createCommonjsModule(function (module) {
module.exports = { "default": require$$0$d, __esModule: true };
});
...
var require$$0$e = ( _objectAssign$1 && _objectAssign ) || _objectAssign$1;

$export$1($export$1.S + $export$1.F, 'Object', { assign: require$$0$e });
...
var require$$0$f = ( assign$1 && assign ) || assign$1;
...
var require$$0$g = ( defineProperty$1 && defineProperty ) || defineProperty$1;
...
var require$$0$h = ( _objectSap$1 && _objectSap ) || _objectSap$1;

require$$0$h('getPrototypeOf', function () {
...
var require$$0$i = ( getPrototypeOf$2 && getPrototypeOf$1 ) || getPrototypeOf$2;
...
var require$$0$j = ( iterator$1 && iterator ) || iterator$1;
...
var hiddenKeys = require$$0$8.concat('length', 'prototype');
...
var require$$0$k = ( _objectGopn$1 && _objectGopn ) || _objectGopn$1;

var gOPN = require$$0$k.f;
...
var require$$0$l = ( _meta$1 && _meta ) || _meta$1;

var require$$0$m = ( _wksDefine$1 && _wksDefine ) || _wksDefine$1;
...
var HIDDEN = require$$0$9('_hidden');
var TO_PRIMITIVE = require$$0$9('toPrimitive');
var isEnum = {}.propertyIsEnumerable;
var SymbolRegistry = require$$0$6('symbol-registry');
var AllSymbols = require$$0$6('symbols');
var OPSymbols = require$$0$6('op-symbols');
...
if (!USE_NATIVE$1) {
  ...
  require$$0$k.f = gOPNExt.f = $getOwnPropertyNames;
  ...
  wksExt.f = function (name) {
    return wrap(require$$0$9(name));
  };
}
$export$1($export$1.G + $export$1.W + $export$1.F * !USE_NATIVE$1, { Symbol: $Symbol });
for (var es6Symbols = (
  'hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables'
).split(','), j = 0; es6Symbols.length > j;)require$$0$9(es6Symbols[j++]);
for (var wellKnownSymbols = getKeys(require$$0$9.store), k = 0; wellKnownSymbols.length > k;) require$$0$m(wellKnownSymbols[k++]);
...
require$$0$m('asyncIterator');

require$$0$m('observable');
...
var require$$0$n = ( symbol$1 && symbol ) || symbol$1;
...
var _setProto = {
  set: Object.setPrototypeOf || ('__proto__' in {} ?
    function (test, buggy, set) {
      try {
        set = require$$0$4(Function.call, require$$1$4.f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var require$$0$o = ( _setProto$1 && _setProto ) || _setProto$1;

$export$1($export$1.S, 'Object', { setPrototypeOf: require$$0$o.set });
...
var require$$0$p = ( setPrototypeOf$1 && setPrototypeOf ) || setPrototypeOf$1;
...
var require$$0$q = ( create$2 && create$1 ) || create$2;
...
var Connection = function () {
  ...
  _createClass(Connection, [{
            ...
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                return timeout$1(function () {
                  if (!_this.client.connected) _this.setClient();
                }, 1000);
              case 5:
                this.client.once('disconnect', _asyncToGenerator(regenerator.mark(function _callee2() {
                  return regenerator.wrap(function _callee2$(_context2) {
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        case 0:
    ...
    key: 'reconnect',
    value: function () {
      var _ref4 = _asyncToGenerator(regenerator.mark(function _callee6(refresh) {
        var _this2 = this;
            ...
            switch (_context6.prev = _context6.next) {
              ...
              case 3:
                ...
                this.client.once('connect', function () {
                  _this2.client.once('disconnect', _asyncToGenerator(regenerator.mark(function _callee4() {
                    return regenerator.wrap(function _callee4$(_context4) {
                      while (1) {
                        switch (_context4.prev = _context4.next) {
                          case 0:
                ...
                _context6.next = 8;
                return timeout$1(_asyncToGenerator(regenerator.mark(function _callee5() {
                  return regenerator.wrap(function _callee5$(_context5) {
                    while (1) {
                      switch (_context5.prev = _context5.next) {
                        case 0:
                          if (!_this2.client.connected) _this2.reload();
                        case 1:
                        case 'end':
    ...
    key: 'reload',
    value: function () {
      var _ref7 = _asyncToGenerator(regenerator.mark(function _callee7(refresh) {
    ...
    key: 'request',
    value: function () {
      var _ref8 = _asyncToGenerator(regenerator.mark(function _callee8(verb, query) {
        var res;
        return regenerator.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 2:
                res = _context8.sent;
                return _context8.abrupt('return', this.errCheck(res, verb, query));
              case 4:
              case 'end':
    ...
    key: 'req',
    value: function () {
      var _ref9 = _asyncToGenerator(regenerator.mark(function _callee9(verb, query) {
        var _this3 = this;
    ...
    key: 'retry',
    value: function () {
      var _ref10 = _asyncToGenerator(regenerator.mark(function _callee10(res, verb, query) {
        var _this4 = this;
        var delay, reres;
        return regenerator.wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 4:
                reres = _context10.sent;
                return _context10.abrupt('return', this.errCheck(reres, verb, query));
              case 6:
              case 'end':
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                ...
                return this.reload();
              case 3:
                return _context11.abrupt('return', this.retry(res, verb, query));
              case 4:
              ...
              case 8:
                ...
                return _context11.abrupt('return', this.retry(res, verb, res.body));
              case 10:
              ...
              case 12:
                return _context11.abrupt('return', this.parse(res));
              case 13:
              case 'end':
