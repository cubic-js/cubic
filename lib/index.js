...
var ServerError = function (_Error) {
  ...
  function ServerError(_ref, query) {
    ...
    var _this = _possibleConstructorReturn(this, (ServerError.__proto__ || _Object$getPrototypeOf(ServerError)).call(this, "Cubic-client encountered an error while requesting " + query + ": " + statusCode + " - " + reason));
