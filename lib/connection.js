        ...
        if (this.reconnecting) {
            ...
            this.reconnecting = new Promise((resolve, reject) => {
                this.auth.reauthorize().then(() => {
                    ...
                    }, 1) // Socket.io is messed up, won't return a working client on reconnect if cast immediately. (somehow disconnects twice, but still has an open connection on server?)
