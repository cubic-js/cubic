...
class Connection {
    ...
    async reconnect() {
        ...
        // Disconnect is async, but doesn't provide callbacks or promises
        // We need to wait for timeouts until this PR gets merged:
        // https://github.com/socketio/socket.io-client/pull/1148
        await timeout(this.client.disconnect, 10)
    ...
    async req(verb, query) {
        ...
        if (this.options.use_socket) {
            return this.client.emit(verb, query, res)
        }
